...
rem C:\lazarus\fpc\2.6.1\bin\i386-win32\ppcrossarm -B -MDelphi -Sghi -O3 -Tlinux -Parm -XXis -vw -Filib\arm-linux -FlC:\android\ndk\platforms\android-8\arch-arm\usr\lib -Fu. -Fu..\.. -FUlib\arm-linux\ -FEjava\libs\armeabi-v7a\ -olibzgeandroid.so -dANDROID -dMINIMAL -Xd -CpARMV6 -CfVFPv2 zgeandroid.pas
